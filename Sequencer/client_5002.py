...
def GPT_response(prompt):
    ...
    prompt_init = f"""
    You will be given a prompt, figure out if the user wants tea or not. 
    Your output needs to be either "yes", "no", "null". 
    You should say "null" when you can't determine if the user wants tea based on the prompt. 
